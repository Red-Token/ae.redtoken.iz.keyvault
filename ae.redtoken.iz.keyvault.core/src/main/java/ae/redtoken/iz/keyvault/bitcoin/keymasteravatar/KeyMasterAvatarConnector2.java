...
public class KeyMasterAvatarConnector2 extends AvatarConnector<KeyMasterStackedService> {
...
//                KeyBag maybeDecryptingKeyBag = new DecryptingKeyBag(internalWallet, req.aesKey);
    ...
    @SneakyThrows
    public KeyMasterAvatarConnector2(DatagramSocket socket, SocketAddress address) {
        super();
    ...
    public KeyMasterAvatarConnector2(KeyMasterExecutor keyMasterRunnable) {
